...
struct Character: Codable, Identifiable {
    ...
    var image: String
    var name: String
    var status: EpChStatus
    var gender: EpChGender
    var location: EpChLocation
...
enum EpChGender: String, Codable {
    case female = "Female"
...
// MARK: - Location
struct EpChLocation: Codable, Identifiable {
    var id: String?
    var name: String
    var dimension: EpChLocationDimension?
}

enum EpChLocationDimension: String, Codable {
...
enum EpChStatus: String, Codable {
    case alive = "Alive"
    case dead = "Dead"
    case unknown = "unknown"
}
